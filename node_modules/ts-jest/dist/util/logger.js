...
var rootLogger = bs_logger_1.createLogger(buildOptions());
exports.rootLogger = rootLogger;
backports_1.backportTsJestDebugEnvVar(rootLogger);
if (original !== process.env.TS_JEST_LOG) {
    exports.rootLogger = rootLogger = bs_logger_1.createLogger(buildOptions());
}
